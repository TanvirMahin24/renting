...
const Terms = () => {
  return (
    <div>
      ...
      <p className="fs-5">Welcome to Renting Site!</p>

      <p className="fs-5">
        These terms and conditions outline the rules and regulations for the use
        of Renting Site's Website, located at rentingsite.com.
      </p>

      <p className="fs-5">
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Renting Site if you do not agree to
      ...
      <h3 className="border_left d-block mt-5">
        <strong>Cookies</strong>
      </h3>

      <p className="fs-5">
        We employ the use of cookies. By accessing Renting Site, you agreed to
        use cookies in agreement with the Renting Site's{" "}
        <Link to="/privacy" className="link_primary">
          Privacy Policy
        </Link>{" "}
        .{" "}
      </p>
      ...
      <p className="fs-5">
        Unless otherwise stated, Renting Site and/or its licensors own the
        intellectual property rights for all material on Renting Site. All
        intellectual property rights are reserved. You may access this from
        Renting Site for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p className="fs-5">You must not:</p>
      <ul className="fs-5 pb-4">
        <li>Republish material from Renting Site</li>
        <li>Sell, rent or sub-license material from Renting Site</li>
        <li>Reproduce, duplicate or copy material from Renting Site</li>
        <li>Redistribute content from Renting Site</li>
      </ul>

      <p className="fs-5">
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Renting Site does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Renting Site,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Renting Site shall not be
      ...
      <p className="fs-5">
        Renting Site reserves the right to monitor all Comments and to remove
        any Comments which can be considered inappropriate, offensive or causes
        breach of these Terms and Conditions.
      </p>

      <p className="fs-5">You warrant and represent that:</p>
      ...
      <p className="fs-5">
        You hereby grant Renting Site a non-exclusive license to use, reproduce,
      ...
      <p className="fs-5">
        ...
        the hyperlink compensates the absence of Renting Site; and (d) the link
      ...
      <p className="fs-5">
        ...
        e-mail to Renting Site. Please include your name, your organization
      ...
      <p className="fs-5">
        No use of Renting Site's logo or other artwork will be allowed for
      ...
      <p className="fs-5">Please read Privacy Policy</p>
